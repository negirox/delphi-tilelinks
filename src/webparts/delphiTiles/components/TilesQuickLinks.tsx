...
export const TilesQuickLinks: React.FunctionComponent<ITilesQuickLinksProps> = (props: React.PropsWithChildren<ITilesQuickLinksProps>) => {
  ...
  const AddLink = ():void => {
    setLinks([...links, {
      ...
      Title: "New link",
      IconName: "Globe",
      Link: "https://delphime.sharepoint.com/",
      Target: "_blank",
      BackgroundColor:"rgb(0, 85, 150)",
      IconColor:"white",
      HoverColor:"rgb(0, 77, 135)"
    }]);
  }
    ...
    <CompoundButton
      ...
      styles={{
        root: {
          ...
          borderRadius: 3,
          backgroundColor: link.BackgroundColor ?? 'rgb(0, 85, 150)'
        },
        rootHovered:{
          backgroundColor: link.BackgroundColor ?? 'rgb(0, 77, 135)'
        },
        textContainer: {
          display: "flex",
          alignItems: "center",
